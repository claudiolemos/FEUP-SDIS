...
public class Client {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      PlateManager server = (PlateManager) registry.lookup(remoteObjectName);
  ...
  private static boolean validArgs(String[] args) {
    if (args.length < 3) {
      ...
      switch (oper) {
        ...
        if (args.length != 4) {
          System.out.println("Usage:");
          System.out.println("\tjava Client <host_name> <remote_object_name> lookup <plate>");
          return false;
        } else {
          plate = args[3];
        }
        ...
        if (args.length != 5) {
          System.out.println("Usage:");
          System.out.println("\tjava Client <host_name> <remote_object_name> register <plate> <owner>");
          return false;
        } else {
          plate = args[3];
          owner = args[4];
